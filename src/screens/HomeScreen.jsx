...
// NOTE: SippIhtCountdown (§Z10) was removed 2026-06-13 — the SIPP-IHT 2027
// warning now flows through HomeAlertsPanel via the Notification Centre stream
// (NC type, severity-ranked) rather than as a standalone full-width banner.
...
// NOTE: DeficitBanner / DeficitBannerView were removed 2026-06-13 — superseded by
// HomeAlertsPanel (the unified "Needs attention" surface backed by the Notification
// Centre stream; the cashflow deficit now arrives as the NC-CF item). Kept this
// pointer so the history isn't a mystery.
