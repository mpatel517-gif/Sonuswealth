...
| Brand strings (FD-NAME-1 sweep) | PASS | NA | NA | Grep across `src/screens/Risk.jsx` for `Caelixa`, `Finio`, `FQ Score`, `FQ ` — **zero matches**. FD-NAME-1 PASS on Risk surface. | Grep output. |
