...
| ID | Element | Type | Owns-subject destination | Verdict | Notes |
|----|---------|------|--------------------------|---------|-------|
| DE-TREE-03 | Decision question heading (`tree.decision`) | DATA | NA | UNVERIFIED | A5/FD-NAME-1: tree text is LLM-generated — verify no Sonuswealth/Finio/FQ Score string drift; verify plain-English |
