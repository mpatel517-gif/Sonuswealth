    ...
    >
      <div style={{ padding: 12 }}>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <Section title="ESTATE (FROM APRIL 2027)">From 6 April 2027 unused pension pots count toward your estate for inheritance tax. <button type="button" onClick={() => setStrategy(true)} style={{ color: 'var(--c-acc,#5ddbc2)', background: 'none', border: 'none', cursor: 'pointer', padding: 0, font: 'inherit' }}>See how this affects your plan →</button></Section>
